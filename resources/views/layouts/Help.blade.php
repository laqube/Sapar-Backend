...
<div class="container-fluid ">
    <div class="row text-center forofor">
        <div class="col-12" style="color: #EEEEEE; margin-top: auto; margin-bottom: auto">
            <h1>404</h1>
            <h3>Sorry, we lost that page...</h3>
            <img src="pics/icons/duck.gif" alt="" style="width: 8rem; ">
        </div>
